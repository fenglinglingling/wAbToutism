...
public class UuidUtil {
         ...
         */
        public  Long randomNumberIsTen() throws Exception {

//        public  Long randomNumberIsTen(int numberNine, int numberOne) throws Exception {
...
//            }
            ...
            String num1 = UuidUtil.randomDigitNumber(numberNine);
            String num2 = UuidUtil.randomDigitNumber(numberOne);
            String num3 = num1 + num2;
            String num4;
            Long num5;
            Long num = Long.parseLong(num3);
            while (num > 9999999999L || num < 9000000000L) {
                num1 = UuidUtil.randomDigitNumber(numberNine);
                num2 = UuidUtil.randomDigitNumber(numberOne);
                num4 = num1 + num2;
